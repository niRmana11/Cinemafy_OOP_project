    ...
    <div class="container">
        ...
        <nav class="sidebar">
            <ul>
                ...
                <li><a href="adminManagement.jsp">Admin Management</a></li>
                <li><a href="reviewsManagement.jsp">Reviews Management</a></li>
                <li><a href="reportsManagement.jsp">Reports Management</a></li>
            </ul>
        </nav>
