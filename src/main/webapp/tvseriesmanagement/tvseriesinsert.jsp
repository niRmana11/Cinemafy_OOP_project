...
<body>
    ...
    <div class="form-container">
        <h2>Insert TV Series Details</h2>
        <form action="../TvSeriesInsertServlet" method="post">
            <table>
                <tr>
                    <td>Title:</td>
                ...
                <tr>
                    <td>Total seasons:</td>
                    <td><input type="number" name="total_seasons" required></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" value="Add TV Series" class="submit-btn">
                    </td>
                </tr>
            </table>
        </form>
