...
public class MovieUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = MovieController.updatedata(movie_id, title, release_date, description, rating, duration, language, poster_image_url, trailer_url);
		
		if(isTrue ==true) {
			
			
			List<MovieModel> moviedetails = MovieController.getById(movie_id);
